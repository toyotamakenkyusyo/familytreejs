...
async function f_familytree(a_url, a_div_id) {
	...
	for (let i1 = 0; i1 < c_data.length; i1++) {
		...
		if (c_father_id !== null) {
			...
			l_paths += "<path d=\"M " + c_father_x + ", " +c_father_y + " L " + c_family_x +  ", " + c_father_y + " L " + c_family_x +  ", " + c_family_y + " L " + c_sibling_x +  ", " + c_family_y + " L " + c_sibling_x +  ", " + c_y + " L " + c_x +  ", " + c_y + "\" />";
		}
		if (c_mother_id !== null) {
			...
			l_paths += "<path d=\"M " + c_mother_x + ", " +c_mother_y + " L " + c_family_x +  ", " + c_mother_y + " L " + c_family_x +  ", " + c_family_y + " L " + c_sibling_x +  ", " + c_family_y + " L " + c_sibling_x +  ", " + c_y + " L " + c_x +  ", " + c_y + "\" />";
		}
	}
